#!/bin/bash
# ========================================================
# MoCo Pre-training script logic
# ========================================================
...
BASE="${SCRATCH}/surgvu_results/pretraining/moco/job_${SLURM_JOB_ID}_${DATE}"
RUN_DIR="${BASE}"
CKPT_DIR="${BASE}"
TB_DIR="${BASE}/tb_logs"
...
Experiment Type: MoCo Pre-training
Epochs: ${EPOCHS}
GPUs: ${GPUS}
...
# TRAIN
############################
echo "[INFO] Launching MoCo pre-training ..."
...
echo "[INFO] MoCo pre-training done."